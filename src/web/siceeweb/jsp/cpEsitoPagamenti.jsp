...
<s:form id="cpEsitoPagamenti" action="cpEsitoPagamenti" namespace="/base/main" method="post">
...
<s:if test="isWidgetVisible('cpEsitoPagamenti','menu')" >
	...
	<!-- endFragment:p_pLeft --></div>
		...
		<div id="centerPanel">
			...
			<div class="wrapper">
				...
				<h3><s:text name="cpEsitoPagamenti.pMain.label" /></h3>
...
<h4 class="fpLabel"><s:text name="cpEsitoPagamenti.pPagamento.label" /></h4>
...
<s:if test="isWidgetVisible('cpEsitoPagamenti','hvPagamentoOK')" >
...
<s:if test="isWidgetVisible('cpEsitoPagamenti','hvPagamentoKO')" >
...
<s:if test="isWidgetVisible('cpEsitoPagamenti','hvPagamentoABORT')" >
...
<s:if test="isWidgetVisible('cpEsitoPagamenti','hvPagamentoANOMAL')" >
