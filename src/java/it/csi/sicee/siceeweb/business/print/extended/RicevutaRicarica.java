 ...
 */
public class RicevutaRicarica extends BaseExtendedPdf {
	...
	public boolean checkGenericDto(GenericDto dati) {
		return dati instanceof RicevutaRicaricaDto;
	}
	...
	protected void addContentPage(Document document, GenericDto dati)
		...
		RicevutaRicaricaDto dto = (RicevutaRicaricaDto) dati;

		StringBuffer strBuffer = new StringBuffer();

		// In data xxx il certificatore xxx con il seguente numero matricola in elenco certificatori xxx ha avviato la seguente richiesta di pagamento:
		
		strBuffer.append("In data " + dto.getDataAcquisto());
		strBuffer.append(" il certificatore " + dto.getNome());
		strBuffer.append(" con il seguente numero matricola in elenco certificatori " + dto.getMatricola());
		strBuffer.append(" ha avviato la seguente richiesta di pagamento:");
		...
		strBuffer.append("\nidentificativo: " + dto.getIdTransazioneMdp());
		strBuffer.append("\nvalore pagamento (Euro): " + Converter.convertToString(dto.getValore()));
		strBuffer.append("\nstato pagamento: " + dto.getStatoPagamento());
	...
	protected void addTitlePage(Document document) throws DocumentException {
		...
		Paragraph par = new Paragraph("RICEVUTA PAGAMENTO", this.chapterFont);
