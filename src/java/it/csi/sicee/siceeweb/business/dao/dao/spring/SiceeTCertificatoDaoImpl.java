...
public class SiceeTCertificatoDaoImpl extends AbstractDAO implements ParameterizedRowMapper<SiceeTCertificato>, SiceeTCertificatoDao
{
	...
	{
		jdbcTemplate.update("UPDATE " + getTableName() + " SET ID_CERTIFICATORE = ?, PROGR_CERTIFICATO = ?, ANNO = ?, DT_SCADENZA = ?, FK_TRANSAZIONE_ACE = ?, DT_ACQUISTO = ?, FK_STATO = ?, FK_DICHIARAZIONE = ?, FLG_DICHIARAZIONE = ?, ID_INDIRIZZO = ?, DESC_INDIRIZZO = ?, DT_INIZIO = ?, CAP = ?, ID_COMUNE = ?, DESC_COMUNE = ?, SEZIONE = ?, ID_PROV = ?, FOGLIO = ?, DESC_PROV = ?, ID_REGIONE = ?, PARTICELLA = ?, SUBALTERNO = ?, DESC_REGIONE = ?, PIANO = ?, NUM_PIANI_COMPLESSIVI = ?, NUM_APPARTAMENTI = ?, SCALA = ?, INTERNO = ?, NOTE = ?, FLG_STAMPA_DEF = ?, NOME_ACE_FIRMATO = ?, NOME_COCERTIFICATORE = ?, COGNOME_COCERTIFICATORE = ?, NUM_COCERTIFICATORE = ?, COD_FISC_COCERTIFICATORE = ?, NUM_CIVICO = ?, IDENTIFIC_PDF = ?, IDENTIFIC_FOTO = ?, LUOGO_DICHIARAZIONE = ?, NOME_FOTO = ?, NOME_PDF = ?, DT_UPLOAD = ?, FLG_EDIFICIO_PERFORMANTE = ?, FLG_SIGMATER = ?, FK_MOTIVO_SOST = ?, DT_SOSTITUZIONE = ?, NOTE_SOSTITUZIONE = ?, DT_FOTO = ?, FLG_OLD = ?, COORD_N = ?, COORD_E = ?, FLG_NO_RACCOMAND = ?, RIF_CATASTO = ?, CODICE_COMUNE_CATASTALE = ?, FK_SCADENZA_CERT = ?, NUM_PIANI_FT_RISC = ?, CF_UTENTE_SOSTITUZIONE = ? WHERE ID_CERTIFICATORE = ? AND PROGR_CERTIFICATO = ? AND ANNO = ?",dto.getIdCertificatore(),dto.getProgrCertificato(),dto.getAnno(),dto.getDtScadenza(),dto.getFkTransazioneAce(),dto.getDtAcquisto(),dto.getFkStato(),dto.getFkDichiarazione(),dto.getFlgDichiarazione(),dto.getIdIndirizzo(),dto.getDescIndirizzo(),dto.getDtInizio(),dto.getCap(),dto.getIdComune(),dto.getDescComune(),dto.getSezione(),dto.getIdProv(),dto.getFoglio(),dto.getDescProv(),dto.getIdRegione(),dto.getParticella(),dto.getSubalterno(),dto.getDescRegione(),dto.getPiano(),dto.getNumPianiComplessivi(),dto.getNumAppartamenti(),dto.getScala(),dto.getInterno(),dto.getNote(),dto.getFlgStampaDef(),dto.getNomeAceFirmato(),dto.getNomeCocertificatore(),dto.getCognomeCocertificatore(),dto.getNumCocertificatore(),dto.getCodFiscCocertificatore(),dto.getNumCivico(),dto.getIdentificPdf(),dto.getIdentificFoto(),dto.getLuogoDichiarazione(),dto.getNomeFoto(),dto.getNomePdf(),dto.getDtUpload(),dto.getFlgEdificioPerformante(),dto.getFlgSigmater(),dto.getFkMotivoSost(),dto.getDtSostituzione(),dto.getNoteSostituzione(),dto.getDtFoto(),dto.getFlgOld(),dto.getCoordN(),dto.getCoordE(),dto.getFlgNoRaccomand(),dto.getRifCatasto(),dto.getCodiceComuneCatastale(),dto.getFkScadenzaCert(),dto.getNumPianiFTRisc(),dto.getCfUtenteSostituzione(), pk.getIdCertificatore(),pk.getProgrCertificato(),pk.getAnno());
	}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FOTO = ? ORDER BY FOTO", this,foto);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE ACE_FIRMATO = ? ORDER BY ACE_FIRMATO", this,aceFirmato);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE CIRCO = ? ORDER BY CIRCO", this,circo);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FK_STATO = ?", this,fkStato);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE ID_CERTIFICATORE = ?", this,idCertificatore);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FK_TRANSAZIONE_ACE = ?", this,fkTransazioneAce);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FLG_CONDOMINIO = ? ORDER BY FLG_CONDOMINIO", this,flgCondominio);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FK_MOTIVO_SOST = ?", this,fkMotivoSost);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
...
from SICEE_T_VERIFY_REPORT)'.
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE dt_upload >= SICEE_T_PARAMETRI.data_upload_inizio_batch and dt_upload < SICEE_T_PARAMETRI.data_upload_fine_batch and fk_stato = ? and identific_pdf is not null and id_certificatore||' '||progr_certificato||' '||anno  not in (select id_certificatore||' '||progr_certificato||' '||anno  from SICEE_T_VERIFY_REPORT)", this,fkStato);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " ORDER BY ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO", this);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE ID_CERTIFICATORE = ? ORDER BY ID_CERTIFICATORE", this,idCertificatore);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE PROGR_CERTIFICATO = ? ORDER BY PROGR_CERTIFICATO", this,progrCertificato);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE ANNO = ? ORDER BY ANNO", this,anno);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE DT_SCADENZA = ? ORDER BY DT_SCADENZA", this,dtScadenza);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FK_TRANSAZIONE_ACE = ? ORDER BY FK_TRANSAZIONE_ACE", this,fkTransazioneAce);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE DT_ACQUISTO = ? ORDER BY DT_ACQUISTO", this,dtAcquisto);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FK_STATO = ? ORDER BY FK_STATO", this,fkStato);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FK_DICHIARAZIONE = ? ORDER BY FK_DICHIARAZIONE", this,fkDichiarazione);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FLG_DICHIARAZIONE = ? ORDER BY FLG_DICHIARAZIONE", this,flgDichiarazione);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE ID_INDIRIZZO = ? ORDER BY ID_INDIRIZZO", this,idIndirizzo);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE DESC_INDIRIZZO = ? ORDER BY DESC_INDIRIZZO", this,descIndirizzo);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE DT_INIZIO = ? ORDER BY DT_INIZIO", this,dtInizio);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE CAP = ? ORDER BY CAP", this,cap);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE ID_COMUNE = ? ORDER BY ID_COMUNE", this,idComune);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE DESC_COMUNE = ? ORDER BY DESC_COMUNE", this,descComune);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE SEZIONE = ? ORDER BY SEZIONE", this,sezione);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE ID_PROV = ? ORDER BY ID_PROV", this,idProv);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FOGLIO = ? ORDER BY FOGLIO", this,foglio);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE DESC_PROV = ? ORDER BY DESC_PROV", this,descProv);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE ID_REGIONE = ? ORDER BY ID_REGIONE", this,idRegione);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE PARTICELLA = ? ORDER BY PARTICELLA", this,particella);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE SUBALTERNO = ? ORDER BY SUBALTERNO", this,subalterno);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE DESC_REGIONE = ? ORDER BY DESC_REGIONE", this,descRegione);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE PIANO = ? ORDER BY PIANO", this,piano);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE NUM_PIANI_COMPLESSIVI = ? ORDER BY NUM_PIANI_COMPLESSIVI", this,numPianiComplessivi);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE NUM_APPARTAMENTI = ? ORDER BY NUM_APPARTAMENTI", this,numAppartamenti);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE SCALA = ? ORDER BY SCALA", this,scala);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE INTERNO = ? ORDER BY INTERNO", this,interno);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE NOTE = ? ORDER BY NOTE", this,note);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FLG_STAMPA_DEF = ? ORDER BY FLG_STAMPA_DEF", this,flgStampaDef);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE NOME_ACE_FIRMATO = ? ORDER BY NOME_ACE_FIRMATO", this,nomeAceFirmato);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE NOME_COCERTIFICATORE = ? ORDER BY NOME_COCERTIFICATORE", this,nomeCocertificatore);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE COGNOME_COCERTIFICATORE = ? ORDER BY COGNOME_COCERTIFICATORE", this,cognomeCocertificatore);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE NUM_COCERTIFICATORE = ? ORDER BY NUM_COCERTIFICATORE", this,numCocertificatore);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE NUM_CIVICO = ? ORDER BY NUM_CIVICO", this,numCivico);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE IDENTIFIC_PDF = ? ORDER BY IDENTIFIC_PDF", this,identificPdf);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE IDENTIFIC_FOTO = ? ORDER BY IDENTIFIC_FOTO", this,identificFoto);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE LUOGO_DICHIARAZIONE = ? ORDER BY LUOGO_DICHIARAZIONE", this,luogoDichiarazione);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE NOME_FOTO = ? ORDER BY NOME_FOTO", this,nomeFoto);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE NOME_PDF = ? ORDER BY NOME_PDF", this,nomePdf);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE DT_UPLOAD = ? ORDER BY DT_UPLOAD", this,dtUpload);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FLG_EDIFICIO_PERFORMANTE = ? ORDER BY FLG_EDIFICIO_PERFORMANTE", this,flgEdificioPerformante);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FLG_SIGMATER = ? ORDER BY FLG_SIGMATER", this,flgSigmater);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FK_MOTIVO_SOST = ? ORDER BY FK_MOTIVO_SOST", this,fkMotivoSost);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE DT_SOSTITUZIONE = ? ORDER BY DT_SOSTITUZIONE", this,dtSostituzione);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE NOTE_SOSTITUZIONE = ? ORDER BY NOTE_SOSTITUZIONE", this,noteSostituzione);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE DT_FOTO = ? ORDER BY DT_FOTO", this,dtFoto);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FLG_OLD = ? ORDER BY FLG_OLD", this,flgOld);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE COORD_N = ? ORDER BY COORD_N", this,coordN);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE COORD_E = ? ORDER BY COORD_E", this,coordE);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE FLG_NO_RACCOMAND = ? ORDER BY FLG_NO_RACCOMAND", this,flgNoRaccomand);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE RIF_CATASTO = ? ORDER BY RIF_CATASTO", this,rifCatasto);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT ID_CERTIFICATORE, PROGR_CERTIFICATO, ANNO, DT_SCADENZA, FK_TRANSAZIONE_ACE, DT_ACQUISTO, FK_STATO, FK_DICHIARAZIONE, FLG_DICHIARAZIONE, ID_INDIRIZZO, DESC_INDIRIZZO, DT_INIZIO, CAP, ID_COMUNE, DESC_COMUNE, SEZIONE, ID_PROV, FOGLIO, DESC_PROV, ID_REGIONE, PARTICELLA, SUBALTERNO, DESC_REGIONE, PIANO, NUM_PIANI_COMPLESSIVI, NUM_APPARTAMENTI, SCALA, INTERNO, NOTE, FLG_STAMPA_DEF, NOME_ACE_FIRMATO, NOME_COCERTIFICATORE, COGNOME_COCERTIFICATORE, NUM_COCERTIFICATORE, COD_FISC_COCERTIFICATORE, NUM_CIVICO, IDENTIFIC_PDF, IDENTIFIC_FOTO, LUOGO_DICHIARAZIONE, NOME_FOTO, NOME_PDF, DT_UPLOAD, FLG_EDIFICIO_PERFORMANTE, FLG_SIGMATER, FK_MOTIVO_SOST, DT_SOSTITUZIONE, NOTE_SOSTITUZIONE, DT_FOTO, FLG_OLD, COORD_N, COORD_E, FLG_NO_RACCOMAND, RIF_CATASTO, CODICE_COMUNE_CATASTALE, FK_SCADENZA_CERT, NUM_PIANI_FT_RISC, CF_UTENTE_SOSTITUZIONE FROM " + getTableName() + " WHERE CODICE_COMUNE_CATASTALE = ? ORDER BY CODICE_COMUNE_CATASTALE", this,codiceComuneCatastale);
		}
		catch (Exception e) {
			throw new SiceeTCertificatoDaoException("Query failed", e);
		}
