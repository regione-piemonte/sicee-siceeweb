...
/** 
 * This class represents the primary key of the SICEE_T_DATI_XML_ED_RIF_2015 table.
 */
public class SiceeTDatiXmlEdRif2015Pk implements Serializable
{
	...
	/**
	 * Method 'SiceeTDatiXmlEdRif2015Pk'
	 * 
	 */
	public SiceeTDatiXmlEdRif2015Pk()
	{
	}
	 ...
	 * @param anno
	 */
	public SiceeTDatiXmlEdRif2015Pk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTDatiXmlEdRif2015Pk)) {
			return false;
		}
		
		final SiceeTDatiXmlEdRif2015Pk _cast = (SiceeTDatiXmlEdRif2015Pk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceeweb.business.dao.dto.SiceeTDatiXmlEdRif2015Pk: " );
