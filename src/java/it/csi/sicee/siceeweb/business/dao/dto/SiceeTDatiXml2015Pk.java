...
/** 
 * This class represents the primary key of the SICEE_T_DATI_XML_2015 table.
 */
public class SiceeTDatiXml2015Pk implements Serializable
{
	 ...
	 * @param anno
	 */
	public SiceeTDatiXml2015Pk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTDatiXml2015Pk)) {
			return false;
		}
		
		final SiceeTDatiXml2015Pk _cast = (SiceeTDatiXml2015Pk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceeweb.business.dao.dto.SiceeTDatiXml2015Pk: " );
