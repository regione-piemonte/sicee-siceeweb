...
/** 
 * This class represents the primary key of the SICEE_T_DATI_XML_ED_REALE_2015 table.
 */
public class SiceeTDatiXmlEdReale2015Pk implements Serializable
{
	...
	/**
	 * Method 'SiceeTDatiXmlEdReale2015Pk'
	 * 
	 */
	public SiceeTDatiXmlEdReale2015Pk()
	{
	}
	 ...
	 * @param anno
	 */
	public SiceeTDatiXmlEdReale2015Pk(final String idCertificatore, final String progrCertificato, final String anno)
	{
		this.idCertificatore = idCertificatore;
		this.progrCertificato = progrCertificato;
		this.anno = anno;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTDatiXmlEdReale2015Pk)) {
			return false;
		}
		
		final SiceeTDatiXmlEdReale2015Pk _cast = (SiceeTDatiXmlEdReale2015Pk) _other;
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceeweb.business.dao.dto.SiceeTDatiXmlEdReale2015Pk: " );
