...
public class SiceeTTransazioneRegistraz implements Serializable
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 767333072104395757L;

	/** 
	 * This attribute maps to the column ID_TRANSAZIONE_REG in the SICEE_T_TRANSAZIONE_REGISTRAZ table.
	 */
	protected long idTransazioneReg;

	/** 
	 * This attribute maps to the column FK_CERTIFICATORE in the SICEE_T_TRANSAZIONE_REGISTRAZ table.
	 */
	protected String fkCertificatore;

	/** 
	 * This attribute maps to the column FK_TIPO_PAGAMENTO in the SICEE_T_TRANSAZIONE_REGISTRAZ table.
	 */
	protected Integer fkTipoPagamento;

	/** 
	 * This attribute maps to the column DATA_TRANSAZIONE in the SICEE_T_TRANSAZIONE_REGISTRAZ table.
	 */
	protected Date dataTransazione;

	/** 
	 * This attribute maps to the column NUM_TRANSAZIONE in the SICEE_T_TRANSAZIONE_REGISTRAZ table.
	 */
	protected String numTransazione;

	/** 
	 * This attribute maps to the column FLG_VERIFICATO in the SICEE_T_TRANSAZIONE_REGISTRAZ table.
	 */
	protected String flgVerificato;

	/** 
	 * This attribute maps to the column ESEGUITO_NOME in the SICEE_T_TRANSAZIONE_REGISTRAZ table.
	 */
	protected String eseguitoNome;

	/** 
	 * This attribute maps to the column ESEGUITO_COGNOME in the SICEE_T_TRANSAZIONE_REGISTRAZ table.
	 */
	protected String eseguitoCognome;

	/** 
	 * This attribute maps to the column ANNO in the SICEE_T_TRANSAZIONE_REGISTRAZ table.
	 */
	protected String anno;

	/** 
	 * This attribute maps to the column QUANTITA in the SICEE_T_TRANSAZIONE_REGISTRAZ table.
	 */
	protected Integer quantita;

	/**
	 * Method 'SiceeTTransazioneRegistraz'
	 * 
	 */
	public SiceeTTransazioneRegistraz()
	{
	}

	/**
	 * Method 'getIdTransazioneReg'
	 * 
	 * @return long
	 */
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SiceeTTransazioneRegistraz)) {
			return false;
		}
		
		final SiceeTTransazioneRegistraz _cast = (SiceeTTransazioneRegistraz) _other;
	 ...
	 */
	public SiceeTTransazioneRegistrazPk createPk()
	{
		return new SiceeTTransazioneRegistrazPk(this.idTransazioneReg);
	}
	...
	public String toString()
	{
		...
		ret.append( "it.csi.sicee.siceeweb.business.dao.dto.SiceeTTransazioneRegistraz: " );
