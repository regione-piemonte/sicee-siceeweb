...
public class ZTImpdatiXml2015 implements Serializable
{
	/** 
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof ZTImpdatiXml2015)) {
			return false;
		}
		
		final ZTImpdatiXml2015 _cast = (ZTImpdatiXml2015) _other;
	 ...
	 */
	public ZTImpdatiXml2015Pk createPk()
	{
		return new ZTImpdatiXml2015Pk(idCertificatore, progrCertificato, anno);
	}
