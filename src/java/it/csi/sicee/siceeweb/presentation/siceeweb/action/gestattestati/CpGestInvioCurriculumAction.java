...
import it.csi.sicee.siceeweb.presentation.siceeweb.action.gestattestati.states.CpGestInvioCurriculumScreenStates;
...
/**
 * CpGestInvioCurriculumAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpGestInvioCurriculumAction extends AbstractCPAction<CpGestInvioCurriculumModel>
		implements
			Preparable,
			ModelDriven<CpGestInvioCurriculumModel> {
	 ...
	 * strato di business.
	 */
	private CpGestInvioCurriculumModel model;
	 ...
	 * strato di business.
	 */
	public CpGestInvioCurriculumModel getModel() {
		return model;
	}
	...
	public void setModel(CpGestInvioCurriculumModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpGestInvioCurriculumModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpGestInvioCurriculum";
	...
	public Class modelClass() {
		return it.csi.sicee.siceeweb.dto.gestattestati.CpGestInvioCurriculumModel.class;
	}
	...
	public String handleBInvioAvanti_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestattestati", "cpgestinviocurriculum", "bInvioAvanti", "CLICKED");
	...
	public String handleTblCurriculumSummary_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestattestati", "cpgestinviocurriculum", "tblCurriculumSummary", "CLICKED");
	...
	public String handleBInvioOK_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestattestati", "cpgestinviocurriculum", "bInvioOK", "CLICKED");

	}

	/**
	 * Gestione dell'evento CLICKED sul widget [bInvioKo]
	 */
	@MethodProtection(level = "REJECT_SAME")
	public String handleBInvioKo_CLICKED() throws CommandExecutionException {

		return handleEventInternal("gestattestati", "cpgestinviocurriculum", "bInvioKo", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R-730948807) ENABLED START*/
