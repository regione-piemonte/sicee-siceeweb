...
public class ScaricaIndicatoreAction extends BaseAction<BaseSessionAwareDTO> {
...
//	private int bufferSize;
	...
	public String execute() throws Exception {
		...
		try {
			 ...
			 String uidIndex = getCertificatoMgr().recuperaUidDocumento(cert, numeroCertificato, Constants.ID_PDF_INDICATORE_APE);
			 
			 LOG.debug("uidDoc: " + uidIndex);
