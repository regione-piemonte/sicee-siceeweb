...
/*PROTECTED REGION ID(R-1170453732) ENABLED START*/
	...
	public Object convertFromString(Map context, String[] values, Class toClass) {
		...
		if (values != null && values.length > 0 && values[0] != null && values[0].trim().length() > 0) {
			...
			try {
				...
				//				System.out
				//						.println("\n\n\n prova 1: " + (!s.matches("^[0-9]*")));
				//				
				//				System.out.println("prova 2: "
				//						+ (parsePosition.getIndex() != s.length()));
				//				
				//				System.out.println("prova 3: " + (n.intValue() < 0));
				//
				//				System.out.println("Stampo Number n: " + n);
				//				System.out.println("Stampo n.intValue(): " + n.intValue());
