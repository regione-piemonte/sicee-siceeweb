...
import it.csi.sicee.siceeweb.dto.gestattestati.CpRicercaAceInviatiModel;
...
import it.csi.sicee.siceeweb.presentation.siceeweb.action.gestattestati.states.CpRicercaAceInviatiScreenStates;
...
/**
 * CpRicercaAceInviatiAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpRicercaAceInviatiAction extends AbstractCPAction<CpRicercaAceInviatiModel>
		implements
			Preparable,
			ModelDriven<CpRicercaAceInviatiModel> {
	 ...
	 * strato di business.
	 */
	private CpRicercaAceInviatiModel model;
	 ...
	 * strato di business.
	 */
	public CpRicercaAceInviatiModel getModel() {
		return model;
	}
	...
	public void setModel(CpRicercaAceInviatiModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpRicercaAceInviatiModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpRicercaAceInviati";
	...
	public Class modelClass() {
		return it.csi.sicee.siceeweb.dto.gestattestati.CpRicercaAceInviatiModel.class;
	}
	...
	public String handleBtnAvantiByCodice_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestattestati", "cpricercaaceinviati", "btnAvantiByCodice", "CLICKED");
	...
	public String handleCbProvRicercaAce_VALUE_CHANGED() throws CommandExecutionException {
		...
		return handleEventInternal("gestattestati", "cpricercaaceinviati", "cbProvRicercaAce", "VALUE_CHANGED");

	}

	/**
	 * Gestione dell'evento VALUE_CHANGED sul widget [cbComRicercaAce]
	 */
	@MethodProtection(level = "REJECT_SAME")
	public String handleCbComRicercaAce_VALUE_CHANGED() throws CommandExecutionException {

		return handleEventInternal("gestattestati", "cpricercaaceinviati", "cbComRicercaAce", "VALUE_CHANGED");
	...
	public String handleBtnAvanti_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestattestati", "cpricercaaceinviati", "btnAvanti", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R1135229978) ENABLED START*/
