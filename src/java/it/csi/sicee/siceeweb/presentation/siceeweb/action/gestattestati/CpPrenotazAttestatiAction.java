...
import it.csi.sicee.siceeweb.dto.gestattestati.CpPrenotazAttestatiModel;
...
import it.csi.sicee.siceeweb.presentation.siceeweb.action.gestattestati.states.CpPrenotazAttestatiScreenStates;
...
/**
 * CpPrenotazAttestatiAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpPrenotazAttestatiAction extends AbstractCPAction<CpPrenotazAttestatiModel>
		implements
			Preparable,
			ModelDriven<CpPrenotazAttestatiModel> {
	 ...
	 * strato di business.
	 */
	private CpPrenotazAttestatiModel model;
	 ...
	 * strato di business.
	 */
	public CpPrenotazAttestatiModel getModel() {
		return model;
	}
	...
	public void setModel(CpPrenotazAttestatiModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpPrenotazAttestatiModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpPrenotazAttestati";
	...
	public Class modelClass() {
		return it.csi.sicee.siceeweb.dto.gestattestati.CpPrenotazAttestatiModel.class;
	}
	...
	public String handleBPagaAvanti_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("gestattestati", "cpprenotazattestati", "bPagaAvanti", "CLICKED");
	...
	public void validate() {
		/*PROTECTED REGION ID(R-158942492) ENABLED START*/
