...
import it.csi.sicee.siceeweb.dto.main.CpBloccoUtenteModel;
...
import it.csi.sicee.siceeweb.presentation.siceeweb.action.main.states.CpBloccoUtenteScreenStates;
...
/**
 * CpBloccoUtenteAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpBloccoUtenteAction extends AbstractCPAction<CpBloccoUtenteModel>
		implements
			Preparable,
			ModelDriven<CpBloccoUtenteModel> {
	 ...
	 * strato di business.
	 */
	private CpBloccoUtenteModel model;
	 ...
	 * strato di business.
	 */
	public CpBloccoUtenteModel getModel() {
		return model;
	}
	...
	public void setModel(CpBloccoUtenteModel modello) {
		this.model = modello;
	}
	 ...
	 */
	private static final String CP_NAME = "cpBloccoUtente";
	...
	public Class modelClass() {
		return it.csi.sicee.siceeweb.dto.main.CpBloccoUtenteModel.class;
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R1800396943) ENABLED START*/
