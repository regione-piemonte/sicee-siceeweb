...
import it.csi.sicee.siceeweb.dto.gestcertificatore.CpDatiCertificatoreModel;
...
import it.csi.sicee.siceeweb.presentation.siceeweb.action.gestcertificatore.states.CpDatiCertificatoreScreenStates;
...
/**
 * CpDatiCertificatoreAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpDatiCertificatoreAction extends AbstractCPAction<CpDatiCertificatoreModel>
		implements
			Preparable,
			ModelDriven<CpDatiCertificatoreModel> {
	 ...
	 * strato di business.
	 */
	private CpDatiCertificatoreModel model;
	 ...
	 * strato di business.
	 */
	public CpDatiCertificatoreModel getModel() {
		return model;
	}
	...
	public void setModel(CpDatiCertificatoreModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpDatiCertificatoreModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpDatiCertificatore";
	...
	public Class modelClass() {
		return it.csi.sicee.siceeweb.dto.gestcertificatore.CpDatiCertificatoreModel.class;
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R1922144330) ENABLED START*/
