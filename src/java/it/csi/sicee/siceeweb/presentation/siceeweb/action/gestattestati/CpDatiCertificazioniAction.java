...
import it.csi.sicee.siceeweb.dto.gestattestati.CpDatiCertificazioniModel;
...
import it.csi.sicee.siceeweb.presentation.siceeweb.action.gestattestati.states.CpDatiCertificazioniScreenStates;
...
/**
 * CpDatiCertificazioniAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpDatiCertificazioniAction extends AbstractCPAction<CpDatiCertificazioniModel>
		implements
			Preparable,
			ModelDriven<CpDatiCertificazioniModel> {
	 ...
	 * strato di business.
	 */
	private CpDatiCertificazioniModel model;
	 ...
	 * strato di business.
	 */
	public CpDatiCertificazioniModel getModel() {
		return model;
	}
	...
	public void setModel(CpDatiCertificazioniModel modello) {
		this.model = modello;
	}
	...
	public void setSession(Map session) {
		...
		if (model == null) {
			model = new CpDatiCertificazioniModel();
		}
	 ...
	 */
	private static final String CP_NAME = "cpDatiCertificazioni";
	...
	public Class modelClass() {
		return it.csi.sicee.siceeweb.dto.gestattestati.CpDatiCertificazioniModel.class;
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R1025211051) ENABLED START*/
