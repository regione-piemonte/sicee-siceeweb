...
public class ScaricaFotoApeAction extends BaseAction<BaseSessionAwareDTO> {
...
//	private int bufferSize;
	...
	public String execute() throws Exception {
		...
		try {
		 ...
		 DatiAttestato attestato = getAppDatacertificato();
		 
		String uidFoto = attestato.getDatiAnagraficiImm().getDtCatastali().getUidFoto();

		 
		 LOG.debug("numeroCertificato: " + numeroCertificato);
		 
		 
		//byte[] certificato = getSoaIntegrationMgr().recuperaDocumento(
