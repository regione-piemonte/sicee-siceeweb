...
/*PROTECTED REGION ID(R814479653) ENABLED START*/
...
public class CpRegistrazTblAttPartOldSummaryCustomDecorator extends TableDecorator {

	public CpRegistrazTblAttPartOldSummaryCustomDecorator() {
		super();

	}

	/*PROTECTED REGION ID(R54271778) ENABLED START*/
	...
	public String getFlgScarico() {
		...
		if (!GenericUtil.isNullOrEmpty(doc.getFlgScarico())) {
			...
			ret = "<a id=\"id_linkable_cell\" href=\"/siceeweb/base/gestcertificatore/cpRegistraz!handleTblAttPartOldSummary_CLICKED.do?idRiga="
					+ uid
					//+ codice
