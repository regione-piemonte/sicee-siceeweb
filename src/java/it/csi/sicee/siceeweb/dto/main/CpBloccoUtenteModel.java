 ...
 * logica di business associata alla Schermata [cpBloccoUtente]
 */
@Validation
public class CpBloccoUtenteModel extends BaseSessionAwareDTO {
	 ...
	 * @generated
	 */
	@VisitorFieldValidator(message = "", key = "cpBloccoUtente.certificatore.visitorvalidator.label", appendPrefix = true)
	...
	/**
	 * imposta il valore dell' ApplicationData 'appDatavaloreMsgBlocco'
	 * @param value
	 * @generated
	 */

	public void setAppDatavaloreMsgBlocco(java.lang.String value) {
		getSession().put("appDatavaloreMsgBlocco", value);
	}

	/**
	 * legge il valore dell' ApplicationData 'appDatavaloreMsgBlocco'
	 * @generated
	 */
	public java.lang.String getAppDatavaloreMsgBlocco() {
		return (java.lang.String) (getSession().get("appDatavaloreMsgBlocco"));
	}
