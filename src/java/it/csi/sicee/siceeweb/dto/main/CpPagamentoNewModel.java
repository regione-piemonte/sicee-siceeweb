 ...
 * logica di business associata alla Schermata [cpPagamentoNew]
 */
@Validation
public class CpPagamentoNewModel extends BaseSessionAwareDTO {
	 ...
	 * @generated
	 */
	@VisitorFieldValidator(message = "", key = "cpPagamentoNew.certificatore.visitorvalidator.label", appendPrefix = true)
