 ...
 * logica di business associata alla Schermata [cpUploadDocAggiuntiva]
 */
@Validation
public class CpUploadDocAggiuntivaModel extends BaseSessionAwareDTO {
	 ...
	 * @generated
	 */
	@VisitorFieldValidator(message = "", key = "cpUploadDocAggiuntiva.certificatore.visitorvalidator.label", appendPrefix = true)
	...
	// FileUpload widg_fileDocCaricato
	private File widgFileDocCaricato; // The actual file(s)
	private String widgFileDocCaricatoContentType; // The content type of the file(s) 
	private String widgFileDocCaricatoFileName; // The uploaded file(s) name and path 

	public void setWidg_fileDocCaricato(File value) {
		widgFileDocCaricato = value;
	}
	@JSON(include = false)
	public File getWidg_fileDocCaricato() {
		return widgFileDocCaricato;
	}

	public void setWidg_fileDocCaricatoContentType(String value) {
		widgFileDocCaricatoContentType = value;
	}
	@JSON(include = false)
	public String getWidg_fileDocCaricatoContentType() {
		return widgFileDocCaricatoContentType;
	}

	public void setWidg_fileDocCaricatoFileName(String value) {
		widgFileDocCaricatoFileName = value;
	}
	@JSON(include = false)
	public String getWidg_fileDocCaricatoFileName() {
		return widgFileDocCaricatoFileName;
	}
