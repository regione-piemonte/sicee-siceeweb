 ...
 * logica di business associata alla Schermata [cpRicercaAceAnnullaSost]
 */
@Validation
public class CpRicercaAceAnnullaSostModel extends BaseSessionAwareDTO {
	 ...
	 * @generated
	 */
	@VisitorFieldValidator(message = "", key = "cpRicercaAceAnnullaSost.certificatore.visitorvalidator.label", appendPrefix = true)
