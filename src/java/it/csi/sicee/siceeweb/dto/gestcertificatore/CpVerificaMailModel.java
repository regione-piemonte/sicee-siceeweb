 ...
 * logica di business associata alla Schermata [cpVerificaMail]
 */
@Validation
public class CpVerificaMailModel extends BaseSessionAwareDTO {
	 ...
	 * @generated
	 */
	@VisitorFieldValidator(message = "", key = "cpVerificaMail.certificatore.visitorvalidator.label", appendPrefix = true)
