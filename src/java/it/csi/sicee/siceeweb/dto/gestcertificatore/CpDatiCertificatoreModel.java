 ...
 * logica di business associata alla Schermata [cpDatiCertificatore]
 */
@Validation
public class CpDatiCertificatoreModel extends BaseSessionAwareDTO {
	 ...
	 * @generated
	 */
	@VisitorFieldValidator(message = "", key = "cpDatiCertificatore.certificatore.visitorvalidator.label", appendPrefix = true)
